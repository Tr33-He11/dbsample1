...
cursor.execute("select num,id, ip,lat,lng,min(radius),radius  from ip2location25306 group by id ")
rows = cursor.fetchall()

file = open('E:\pycharmprojects\dbsample1\data\location25306.txt','a')            #写入txt文本
